...
public class Sing_Up extends AppCompatActivity {
    ...
    public void terminosClick(){
        ...
        builder.setTitle("Terminos y condiciones de Maniacorp: ")
                .setMessage("TÉRMINOS DE SERVICIO\n" +
                        "\n" +
                        "----\n" +
                        "\n" +
                        "INFORMACIÓN GENERAL\n" +
                        "\n" +
                        "Este sitio es operado por Maniacorp. En todo el sitio, los términos “nosotros”, “nos” y “nuestro” se refieren a Maniacorp. Maniacorp ofrece este sitio web, incluyendo toda la información, herramientas y servicios disponibles para ti en este sitio, el usuario, está condicionado a la aceptación de todos los términos, condiciones, políticas y notificaciones aquí establecidos.\n" +
                        "\n" +
                        ...
                        "\n" +
                        "\n" +
                        "SECCIÓN 1 - TÉRMINOS DE LA APLICACION WEB Y PAGOS EN LINEA\n" +
                        "\n" +
                        "Al utilizar esta app , declaras que tienes al menos la mayoría de edad en tu estado o provincia de residencia, o que tienes la mayoría de edad en tu estado o provincia de residencia y que nos has dado tu consentimiento para permitir que cualquiera de tus dependientes menores use este sitio.\n" +
                        "\n" +
                        ...
                        "SECCIÓN 18 - LEY\n" +
                        "\n" +
                        "Estas Condiciones del servicio y cualquier acuerdos aparte en el que te proporcionemos servicios se regirán e interpretarán en conformidad con las leyes de Calle Jose Santos Valdez Col Magisterial, Lerdo, DUR, 35168, Mexico.\n" +
                        "\n" +
                        "\n" +
                        ...
                        "\n" +
                        "Preguntas acerca de los Términos de Servicio deben ser enviadas a maniacorp@gmail.com.")
    ...
    private void realizarConexion(){
        ...
        String url = "http://maniacorp.ddns.net:3000/usuarios";
